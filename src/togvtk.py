...
for f in files:
    arr.InsertNextValue(os.path.join(fpath, f))
...
#arr.InsertNextValue('data/pngstack/ExpID3002_spch4_TL003_plantD_lif_S000_T000_C000_Z026.png')
#arr.InsertNextValue('data/pngstack/ExpID3002_spch4_TL003_plantD_lif_S000_T000_C000_Z027.png')
#arr.InsertNextValue('data/pngstack/ExpID3002_spch4_TL003_plantD_lif_S000_T000_C000_Z028.png')
#arr.InsertNextValue('data/pngstack/ExpID3002_spch4_TL003_plantD_lif_S000_T000_C000_Z029.png')
#arr.InsertNextValue('data/pngstack/ExpID3002_spch4_TL003_plantD_lif_S000_T000_C000_Z030.png')
#arr.InsertNextValue('data/pngstack/ExpID3002_spch4_TL003_plantD_lif_S000_T000_C000_Z031.png')
#arr.InsertNextValue('data/pngstack/ExpID3002_spch4_TL003_plantD_lif_S000_T000_C000_Z032.png')
...
data.SetExtent(0, 500, 0, 500, 0, len(files))
#
...
alphaChannelFunc.AddPoint(250, 0.0)
